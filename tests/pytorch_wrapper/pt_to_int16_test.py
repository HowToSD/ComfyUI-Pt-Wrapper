...
from pytorch_wrapper.pt_to_int16 import PtToInt16


class TestPtToInt16(unittest.TestCase):
    def setUp(self):
        ...
        self.test_cases = [
            (torch.tensor([1.0, 2.0, 3.0], dtype=torch.float32), torch.tensor([1, 2, 3], dtype=torch.int16), torch.int16),
        ]
