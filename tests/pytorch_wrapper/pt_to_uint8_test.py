...
from pytorch_wrapper.pt_to_uint8 import PtToUint8


class TestPtToUint8(unittest.TestCase):
    def setUp(self):
        ...
        self.test_cases = [
            (torch.tensor([1.0, 2.0, 3.0], dtype=torch.float32), torch.tensor([1, 2, 3], dtype=torch.uint8), torch.uint8),
        ]
