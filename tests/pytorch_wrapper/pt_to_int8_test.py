...
from pytorch_wrapper.pt_to_int8 import PtToInt8


class TestPtToInt8(unittest.TestCase):
    def setUp(self):
        ...
        self.test_cases = [
            (torch.tensor([1.0, 2.0, 3.0], dtype=torch.float32), torch.tensor([1, 2, 3], dtype=torch.int8), torch.int8),
        ]
