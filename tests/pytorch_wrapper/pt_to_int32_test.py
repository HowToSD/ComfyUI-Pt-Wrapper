...
from pytorch_wrapper.pt_to_int32 import PtToInt32


class TestPtToInt32(unittest.TestCase):
    def setUp(self):
        ...
        self.test_cases = [
            (torch.tensor([1.0, 2.0, 3.0], dtype=torch.float32), torch.tensor([1, 2, 3], dtype=torch.int32), torch.int32),
        ]
