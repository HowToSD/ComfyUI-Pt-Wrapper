...
from pytorch_wrapper.ptn_max_pool2d import PtnMaxPool2d


class TestPtnMaxPool2dModel(unittest.TestCase):
    def setUp(self):
        """Set up test instance."""
        self.model_node = PtnMaxPool2d()
