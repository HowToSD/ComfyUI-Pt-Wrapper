...
from pytorch_wrapper.ptn_hf_lora_classification_model import PtnHfLoraClassificationModel
from hugging_face_wrapper.hf_tokenizer_encode import HfTokenizerEncode


class TestPtfHfLoraClassificationModel(unittest.TestCase):
    def setUp(self):
    ...
    def test_all_models(self):
        ...
        for model_name in self.model_names:
            with self.subTest(model_name=model_name):
                ...
                model = PtnHfLoraClassificationModel().f(
                    model_name,
    ...
    def test_all_models_with_full_params(self):
        """Test with full params for all supported models."""
        for model_name in self.model_names:
            with self.subTest(model_name=model_name):
                encode = HfTokenizerEncode().f(
                    model_name=model_name,
