...
class PtBitwiseLeftShift:
    ...
    def f(self, tens_a: torch.Tensor, tens_b: torch.Tensor) -> tuple:
        """
        Performs a bitwise left shift operation on two PyTorch tensors.
        ...
        Returns:
            tuple: A tuple containing the resultant tensor after applying bitwise left shift.
        """
        return (torch.bitwise_left_shift(tens_a, tens_b),)
