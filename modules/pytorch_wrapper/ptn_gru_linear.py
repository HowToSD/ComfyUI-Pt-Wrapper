...
class GRULinear(nn.Module):
    """
    A recurrent neural network (GRU) with a linear output layer.
    
    This module uses a standard PyTorch GRU, followed by a linear layer applied to the final output tensor.
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        """
        Forward pass through the GRU and the linear layer.
        ...
        """
        out_seq, _ = self.gru_model(inputs)
