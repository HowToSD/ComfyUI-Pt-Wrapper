...
class PtBitwiseXor:
    ...
    def f(self, tens_a: torch.Tensor, tens_b: torch.Tensor) -> tuple:
        """
        Performs a bitwise XOR operation on two PyTorch tensors.
        ...
        Returns:
            tuple: A tuple containing the resultant tensor after applying bitwise XOR.
        """
        return (torch.bitwise_xor(tens_a, tens_b),)
